...
output: 
  html_document:
    ...
    toc: yes
    toc_float: yes
    theme: journal #theme I like... pick your own from here(https://bookdown.org/yihui/rmarkdown/html-document.html#appearance-and-style) and follow the bootswatch link
    highlight: zenburn
date: "2023-06-19"
---
